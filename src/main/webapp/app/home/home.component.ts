...
export class HomeComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    public carouselImages = [
        ...
        'https://lukerimages.000webhostapp.com/img/main.jpg?d=' + new Date().getTime(),
        'https://lukerimages.000webhostapp.com/img/imagen-1.jpg?d=' + new Date().getTime(),
        'https://lukerimages.000webhostapp.com/img/imagen-2.jpg?d=' + new Date().getTime(),
        'https://lukerimages.000webhostapp.com/img/imagen-3.jpg?d=' + new Date().getTime(),
    ];
